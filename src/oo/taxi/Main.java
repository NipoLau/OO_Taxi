...
public class Main {
	...
	public static void main(String[] args) {
		...
		for (int i = 0 ; i < TAXINUM ; i++) {
			new Thread(new Taxi(i, taxidata, gui, mi.map, shortpath, flowmap, manager, detail, lightGroup)).start();
		...
		inputHandler handler = new inputHandler(reqQueue, SYSTIME, roadctr, filehandler);
